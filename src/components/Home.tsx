  ...
  return (
    <Wrapper>
      ...
      <PDiv className={typingEnd ? "visiable" : ""}>
        <P>
          A web front-end engineers,chinese name is 高克鑫.There are my{" "}
          <A href="https://github.com/Gouson" target="_blank">
            {" "}
            GitHub
          </A>{" "}
          ,{" "}
          <A href="https://www.yuque.com/gouson" target="_blank">
            Yuque
          </A>{" "}
          ,{" "}
          <A href="https://weibo.com/u/6410825202" target="_blank">
            Weibo
          </A>
        </P>
        <P>
          If it's about work, please email me{" "}
          <A href="mailto:gaokx36@gmail.com">gaokx36@gmail.com</A> or{" "}
          <A href="mailto:gouson@qq.com">gouson@qq.com</A>
        </P>
      </PDiv>
      <iframe
        frameBorder="no"
        ...
        width={330}
        height={86}
        src="//music.163.com/outchain/player?type=2&id=1888864514&auto=1&height=66"
      ></iframe>
    </Wrapper>
  );
};
